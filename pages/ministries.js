...
const Ministries = () => {
    ...
    return (
        <div className="mx-20 lg:mx-44">
            <p className="text-xl md:text-2xl lg:text-3xl my-8 text-center text-red-800 font-semibold tracking-wider">
                Ministries
            </p>

            <p className='text-sm md:text-md lg:text-lg mt-2'>
                Jesus, the Good Shepherd Parish welcomes you to our parish family and invite you to be a Christian steward of your God-given
                gifts of time and talent. We offer many ways to employ these gifts through our ministries listed below. We ask you to prayerfully reflect over these opportunities and ask yourself…
                “Will I make some return to God this coming year by hearing His name?”
            </p>

            <p className="text-lg md:text-xl lg:text-2xl mt-8 text-sky-600">
                Ministry through Education
            </p>

            <p className="text-md md:text-lg lg:text-xl mt-5 text-sky-600">
                Religious Education Grades 1-8
            </p>

            <p className="text-sm md:text-md lg:text-lg text-[#ad534f] italic mt-2">
            ...
            <p className="text-md md:text-lg lg:text-xl mt-8 text-sky-600">
                Holy Innocents
            </p>
            ...
            <div className="w-3/5 h-[1px] bg-[#C9D5D9] mx-auto my-5 lg:my-16"></div>
            ...
            <Link href={`mailto: ${"j.bedoya@jesusthegoodshepherd.org"}`}>
                <a className="text-gray-600 text-sm md:text-md lg:text-lg">j.bedoya@jesusthegoodshepherd.org</a>
            </Link>
            ...
            <p className="text-sm md:text-md lg:text-lg mt-2 mb-8">
